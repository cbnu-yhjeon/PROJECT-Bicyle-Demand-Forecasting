...
if __name__ == "__main__":
    add_weathersit_flag(
        ...
        output_csv=r"/mnt/c/projects/PROJECT-Bicyle-Demand-Forecasting/Data/processed/seoul/Contextual Data/weather/merged_with_time_features_filled_flagged_weathersit.csv",
    )
